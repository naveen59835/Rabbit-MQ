package org.c2s3mc.Track.config;
...
public class MessageConfiguration {
    private String exchangeName="UserTrackExchange";
    private String queueName="UserTrackQueue";
    @Bean
    ...
    public Binding getBinding(){
        return BindingBuilder.bind(getQueue()).to(getDirectExchange()).with("track_routing");
    }
